<%-- 
    Document   : Register
    Created on : May 25, 2015, 5:30:18 AM
    Author     : adina.pirjol
--%>
                            ...
                            <div class="input-group">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                      <%String fbURL = "http://www.facebook.com/dialog/oauth?client_id=110858295914441&redirect_uri=" + URLEncoder.encode("http://localhost:8080/wad_project/","UTF-8") + "&scope=email";%>

                                      <a id="btn-login" href="login" class="btn btn-success">Login  </a>
                                      <a id="btn-fblogin" href="<%= fbURL %>" class="btn btn-primary">
                                            Login with Facebook
                                      </a>
                                    </div>
                                </div>
                        ...
                        <div class="panel-body" >
                            <form id="signupform" class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="city" placeholder="Where do you live?">
                                    </div>
                                </div>
