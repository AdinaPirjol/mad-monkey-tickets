...
public class AddToShoppingCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getSession().getAttribute("shoppingCart") == null) {
            ...
            c = (ShoppingCart) request.getSession().getAttribute("shoppingCart");
        }
        ...
        for(String id:ticketIds) {
            EventTicket ticket = em.find(EventTicket.class, request.getParameter("ticketId"));
            c.addTicket(ticket);
        }
        
        request.getSession().setAttribute("shoppingCart", c);
